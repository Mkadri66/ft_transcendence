...
export default async function dashboardRoute(app) {
    app.get('/dashboard', async (request, reply) => {
        try {
            ...
            const userCount = db
                ...
                .get(userId);
            console.log("Nombre d'utilisateurs disponibles :", userCount.count);
    ...
    `
            ...
            console.log('Amis suggérés :', suggestedFriends);

            // Vérifiez toutes les relations d'amitié
            const allFriends = db.prepare('SELECT * FROM friends').all();
            console.log("Relations d'amitié existantes :", allFriends);
...
`
            ...
            console.log("Amis de l'utilisateur courant :", userFriends);
